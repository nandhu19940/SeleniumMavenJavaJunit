...
//		Assert.assertEquals("Swag Labs", pageTitle);
		WebElement username = driver.findElement(By.xpath(obj.usernameTextBoxFacebook()));
		WebElement password = driver.findElement(By.xpath(obj.passwordTextBoxFacebook()));
		WebElement loginButton = driver.findElement(By.xpath(obj.loginButtonFacebook()));
		username.sendKeys(obj.userIDFacebook());
		password.sendKeys(obj.passcodeFacebook());
		loginButton.click();
